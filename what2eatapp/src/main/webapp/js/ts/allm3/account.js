...
var AccoutForbiddenChat = (function (_super) {
    ...
    AccoutForbiddenChat.prototype.forbiddenChat = function (successCallback) {
    	var cmdType = this.$('#cmd_type').val();
        var channelId = this.$('#channel_id').val();
        var area = this.$('#area').val();
        var playerID = this.$.trim($('#player_id').val());
        var agency = this.$.trim(this.$('#agency').val());
        var startTime = $.trim(this.$('#start_time').val());
