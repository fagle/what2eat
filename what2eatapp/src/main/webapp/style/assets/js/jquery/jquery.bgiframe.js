...
(function(factory){
    ...
    $.fn.bgiframe = function(s){
        ...
        var $iframe = $('<iframe class="bgiframe" frameborder="0" tabindex="-1" src="' + s.src + '"' + 'style="position:absolute; z-index:-1; display:block;"></iframe>');
