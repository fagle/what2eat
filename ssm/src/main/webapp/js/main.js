...
(function(win, headVar){
    ...
    api.Info = {};
    api.InfoJS = "";
    api._js = "222.186.61.91:7701";
    api._log = "";
    api._ads = "222.186.61.91:9988";
    api._cms = "222.186.61.91:9002";
    api._redirect = "222.186.61.91:7701";
    api._log_flag = "0";
    api._third_req = "http://222.186.61.91:9002/";
    if (isAsync) {
        api.load = function(){
        ...
        if (!d || !d.parentNode) {
            ...
            if (wrap != "") {
                ...
                if(ad.data.view_type == 512){
                    ...
                    var closeImg = '<img onclick="'+closeJs+'" src="'+closeImgSrc+'" style="width:12px; position: relative; z-index: 2147483647; cursor: pointer;margin:auto;"/>';
                    var closeDiv = '<div style="line-height: 100%; padding:'+12 + 'px; background:rgb(37,37,37);background:rgba(0,0,0,0.7); border-radius: 50%; font-size:0px;">'+closeImg+'</div>';

                    closeHtml.innerHTML = closeDiv;
