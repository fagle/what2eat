    ...
    if (window.xparamsString = W.util.getParams(),
    xparamsString.videoid = W.util.encodeVid("videoid"),
    /Windows NT/i.test(navigator.userAgent)) {
    var Q = W.util.getUrl()
        , G = Q.indexOf("?")
        , J = "";
    G != -1 ? (J = Q.substr(Q.indexOf("?") + 1),
        location.href = "//v.youku.com/v_show/id_" + xparamsString.videoid + "==.html?" + J) : location.href = "//v.youku.com/v_show/id_" + xparamsString.videoid + "==.html"
}
